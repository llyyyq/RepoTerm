...
to allow RepoTerm to save and restore conversation state across restarts.
...
from repoterm.logging_config import log_session_event
...
SESSIONS_DIR = REPOTERM_DIR / "sessions"
...
def _session_index_file() -> Path:
    ...
    return REPOTERM_DIR / "sessions_index.json"
