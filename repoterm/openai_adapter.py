"""OpenAI-compatible API adapter for RepoTerm.
...
from repoterm.api_retry import RETRYABLE_STATUS, calculate_backoff
from repoterm.cost_tracker import calculate_cost
from repoterm.state import Store, AppState, add_cost, record_api_error, update_context_usage
from repoterm.types import AgentStep, StepDiagnostics

DEFAULT_MAX_RETRIES = 4
OPENAI_MODELS = {"gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-5.5", "gpt5.5", "o1", "o1-mini", "o3-mini"}
DEFAULT_OPENAI_USER_AGENT = "RepoTerm/0.5.0 (OpenAI-Compatible Adapter)"
...
class OpenAIModelAdapter:
    ...
    def next(
        ...
        for attempt in range(max_retries + 1):
            try:
                timeout = int(os.environ.get("REPOTERM_MODEL_TIMEOUT", "120"))
                ...
                if (
                    ...
                    break
                from repoterm.api_retry import classify_error
