...
The harness compares a static baseline with RepoTerm's current cybernetic
...
DEFAULT_TASKS = [
    ...
    AblationTaskProfile(
        ...
        label="refactor",
        changed_files=("repoterm/model_registry.py", "repoterm/pipeline_engine.py"),
    ...
    AblationTaskProfile(
        ...
        label="long_context",
        changed_files=("REPOTERM_CYBERNETICS_INTEGRATION_ANALYSIS.zh.md", "repoterm/context_cybernetics.py"),
        intent_type="code",
        action_type="update",
        complexity="moderate",
        context_usage=0.84,
    ...
    AblationTaskProfile(
        ...
        label="multi_tool",
        changed_files=("repoterm/tooling.py", "tests/test_tooling.py"),
        intent_type="code",
        action_type="update",
        complexity="moderate",
        context_usage=0.52,
    ...
    AblationTaskProfile(
        ...
        changed_files=("repoterm/self_healing_engine.py", "tests/test_self_healing.py"),
        intent_type="debug",
        action_type="update",
        complexity="complex",
        context_usage=0.73,
