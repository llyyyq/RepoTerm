...
from repoterm.config import get_mcp_config_path, load_scoped_mcp_servers, save_scoped_mcp_servers
from repoterm.skills import discover_skills, install_skill, remove_managed_skill


def _print_usage() -> None:
    print(
        "repoterm management commands\n\n"
        "repoterm mcp list [--project]\n"
        "repoterm mcp add <name> [--project] [--protocol <auto|content-length|newline-json>] [--env KEY=VALUE ...] -- <command> [args...]\n"
        "repoterm mcp remove <name> [--project]\n\n"
        "repoterm skills list\n"
        "repoterm skills add <path-to-skill-or-dir> [--name <name>] [--project]\n"
        "repoterm skills remove <name> [--project]\n\n"
        "repoterm valid-config"
    )
