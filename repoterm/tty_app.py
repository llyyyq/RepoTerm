"""RepoTerm TTY Application.

This module implements the full-screen terminal user interface for RepoTerm,
including:
...
from repoterm.tui.chrome import _cached_terminal_size
from repoterm.tui.input_parser import (
    KeyEvent,
    ParsedInputEvent,
    TextEvent,
    parse_input_chunk,
...
from repoterm.types import ChatMessage, ModelAdapter

# ---------------------------------------------------------------------------
from repoterm.tui.state import ScreenState
from repoterm.tui.tool_helpers import _summarize_collapsed_tool_body, _summarize_tool_input, _apply_tool_result_visual_state as _shared_apply_tool_result_visual_state, _mark_unfinished_tools as _shared_mark_unfinished_tools, _save_transcript as _shared_save_transcript
from repoterm.tui.event_flow import _handle_event as _handle_tty_event
from repoterm.tui.runtime_control import _ThrottledRenderer, enter_tty_runtime, exit_tty_runtime, install_sigwinch_rerender
from repoterm.tui.session_flow import handle_session_listing, load_or_create_session, build_tty_runtime_state, install_permission_prompt, finalize_tty_session
from repoterm.tui.renderer import _render_screen
from repoterm.tui.input_handler import _RawModeContext, _handle_input, _win_read_one_key
