"""Unified model registry and routing for RepoTerm.
...
def model_id_supports_agent_tools(model: str) -> bool:
    """Conservatively identify model IDs suitable for RepoTerm tool calls.
...
def build_provider_config(model: str, runtime: dict[str, Any] | None = None) -> ProviderConfig:
    ...
    if provider == Provider.OPENROUTER:
        return ProviderConfig(
            ...
            extra_headers={
                "HTTP-Referer": os.environ.get("OPENROUTER_REFERER", "https://github.com/repoterm"),
                "X-Title": os.environ.get("OPENROUTER_TITLE", "RepoTerm"),
            },
            extra_params={
...
def create_model_adapter(
    ...
    """
    if force_mock or os.environ.get("REPOTERM_MODEL_MODE") == "mock":
