...
from repoterm.task_object import TaskObject, TaskState, ConstraintType
from repoterm.cybernetic_supervisor import CyberneticSupervisor
from repoterm.decision_audit import get_auditor, DecisionType, DecisionOutcome
from repoterm.logging_config import get_logger
from repoterm.progress_controller import ProgressController, ProgressSignal
from repoterm.verification_controller import VerificationController
...
def process_task(raw_input: str) -> tuple[TaskObject, PipelinePlan, PipelineResult]:
    ...
    from repoterm.task_object import build_task
