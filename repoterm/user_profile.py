...
- Project: .repoterm/USER.md   (project-specific overrides)
...
class UserProfileManager:
    ...
    def __init__(self, cwd: str | Path | None = None):
        ...
        self._global_path = REPOTERM_DIR / "USER.md"
        self._project_path = Path(cwd or Path.cwd()) / ".repoterm" / "USER.md"
...
def handle_user_command(args: str, cwd: str | Path | None = None) -> str:
    ...
    if not subcmd or subcmd == "show":
        ...
        if not prompt_section:
            return "No user profile configured. Create ~/.repoterm/USER.md or .repoterm/USER.md"
