...
from repoterm.history import load_history_entries
...
from repoterm.tui.state import PendingApproval, ScreenState, TtyAppArgs
from repoterm.tui.tool_lifecycle import _bump_transcript_revision
