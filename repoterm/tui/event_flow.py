...
from repoterm.tui.input_parser import KeyEvent, ParsedInputEvent, TextEvent, WheelEvent
from repoterm.tui.navigation import (
...
def _handle_normal_mode_key(
    ...
    if event.name == "home" and event.ctrl:
        from repoterm.tui.navigation import _get_max_transcript_scroll_offset
