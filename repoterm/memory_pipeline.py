...
class MemoryPipeline:
    ...
    def initialize(
        ...
        if self._memory:
            from repoterm.memory_injector import MemoryInjector
        ...
        from repoterm.memory_curator_agent import MemoryCuratorAgent
        ...
        if enable_vector:
            try:
                from repoterm.vector_memory import SparseVectorStore, VectorMemoryStore
    ...
    def _state_path(self) -> str | None:
        ...
        if not self._workspace:
            return None
        import os
        return os.path.join(self._workspace, ".repoterm-memory", "pipeline_state.json")
    ...
    def read(
        ...
        if self._vector_store and self._vector_store.enabled:
            try:
                ...
                if vec_results:
                    from repoterm.vector_memory import merge_bm25_vector
    ...
    def _get_active_domains(
        ...
        try:
            from repoterm.domain_classifier import get_active_domain_values
