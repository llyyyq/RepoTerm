...
from repoterm.config import describe_fallback_guidance, describe_provider_channel
from repoterm.context_manager import ContextManager, estimate_message_tokens
...
from repoterm.state import Store, AppState, increment_tool_calls, set_busy, set_idle
from repoterm.tooling import ToolContext, ToolRegistry, ToolResult
...
# Hooks integration
from repoterm.hooks import HookEvent, fire_hook_sync

# Intelligence integration
from repoterm.agent_metrics import AgentMetricsCollector
from repoterm.agent_intelligence import ErrorClassifier, NudgeGenerator, ToolScheduler
from repoterm.working_memory import get_working_memory, protect_context

# Work chain integration
from repoterm.intent_parser import parse_intent
from repoterm.task_object import build_task, TaskObject, TaskState
from repoterm.task_graph import TaskGraph, TaskState as GraphTaskState
from repoterm.pipeline_engine import get_pipeline_engine
from repoterm.capability_registry import get_registry, CapabilityDomain
from repoterm.layered_context import ContextBuilder, LayeredContext
from repoterm.decision_audit import get_auditor, DecisionOutcome
from repoterm.runtime_profiles import resolve_runtime_profile

# 工程控制论集成
from repoterm.cybernetic_orchestrator import CyberneticOrchestrator
from repoterm.cybernetic_supervisor import save_supervisor_report
from repoterm.feedforward_controller import FeedforwardController

# 高级控制论模块
from repoterm.state_observer import MeasurementVector
...
# 智能路由与自省 (Phase 3 导入)
from repoterm.smart_router import TaskOutcome
...
def _register_tool_capabilities(tools: ToolRegistry) -> None:
    ...
    for tool_name in tools.list_all():
        try:
            from repoterm.capability_registry import CapabilityMetadata, CapabilityScope
...
def _execute_single_tool(
    ...
    try:
        ...
        import concurrent.futures
        import os
        _base_timeout = int(os.environ.get("REPOTERM_TOOL_TIMEOUT", "120"))
        TOOL_TIMEOUT = (
...
def run_agent_turn(
    *,
    ...
    # the optional work chain: callers may provide a context manager while the
    # work chain is disabled.
    ...
    try:
        ...
        if stability_monitor:
            from repoterm.stability_monitor import MetricSnapshot
