...
SLASH_COMMANDS = [
    ...
    SlashCommand("/history", "/history", "Show recent prompt history from ~/.repoterm/history.json."),
    ...
    SlashCommand("/model", "/model <model-name>", "Persist a model override into ~/.repoterm/settings.json."),
    SlashCommand("/config-paths", "/config-paths", "Show repoterm and Claude fallback settings paths."),
    ...
    SlashCommand("/permissions", "/permissions", "Show repoterm permission storage path."),
    SlashCommand("/exit", "/exit", "Exit repoterm."),
